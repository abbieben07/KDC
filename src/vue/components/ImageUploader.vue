...
import { Options, Prop, Ref, Vue, Watch } from "vue-decorator"
...
export default class ImageUploader extends Vue {
	...
	async onSubmit() {
		if (this.ratio) {
			...
			if (ratio != this.ratio) return (this.message = "The Selected Image Aspect Ratio is not Acceptabled, Please edit your image")
		}
